...
public class Customer implements java.io.Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -4553345423260560203L;
	private Integer cid;
	...
	/** minimal constructor */
	public Customer(Date startDate, String legalRepresentative) {
		this.startDate = startDate;
		this.legalRepresentative = legalRepresentative;
	}

	public Customer(Date startDate, String company, Float cost,
	...
	public Customer(Date startDate, String company, Float cost,
			...
			String qq, String micromsg, String introduction,
			String cooperationProject, String possibleBusiness,
			String clientEvaluation, String comment,Department department,String area) {
		this.startDate = startDate;
		this.company = company;
		this.cost = cost;
		this.legalRepresentative = legalRepresentative;
